...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    ...
    <button class="w3-button w3-black">Agregar</button></h5></h5>
  </header>

<div class="w3-container"> <!--agregar 
  <h5>Nuevo Producto <button class="w3-button w3-black">Agregar</button></h5>
-->
<br>
  <table class="w3-table-all w3-text-theme w3-centered w3-theme-d1">
    ...
    <tr>
      ...
      <th>calle, col</th>
      <td>
          <imput type="button" onclick="location='editar'"/>
          <button class="w3-button w3-orange">Editar</button>
